	...
	<body id="bodyPrincipal">
	    ...
	    <div class="container containerPrincipal">
			<div class="alert alert-success text-center" role="alert">
		      <strong>Categoria Infantil: </strong>Escolha uma modalidade para cadastrar alunos:
		    </div>
				...
				<!-- Table -->
						<table class="table">
					        ...
					        <?php /* Puxando todas modalidades cadastradas para esta escola... */
					        	...
					        	$query = "SELECT * FROM escola_categoria_modalidade INNER JOIN modalidade ON escola_categoria_modalidade.id_modalidade = modalidade.id WHERE id_escola = '$id_escola' AND id_categoria = '3';";
					          ...
					          <tr>
					            ...
					            <td>
									<div class="btn-group" role="group" aria-label="...">
									  <a class="btn btn-primary btn-sm" href="insere_alunos_modalidades.php?id_categoria=3&id_modalidade=<?php echo $row['id_modalidade']; ?>">Cadastrar Alunos</a>
									</div>
					            </td>
					          </tr>
